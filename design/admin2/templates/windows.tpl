...
<div id="node-tab-view-extras-content" class="tab-content{if $node_tab_index|ne('view_extras')} hide{else} selected{/if}">
    {include uri='design:admin_node_tab/view_extras.tpl'}
<div class="break"></div>
</div>
